...
class BoxyDonateCommand(sublime_plugin.WindowCommand):
    def run(self):
        webbrowser.open_new_tab('https://github.com/karmicdude/sublime-boxy#share-the-love')
...
class BoxyIssuesCommand(sublime_plugin.WindowCommand):
    def run(self):
        webbrowser.open_new_tab('https://github.com/karmicdude/sublime-boxy/issues')
...
class BoxyRepoCommand(sublime_plugin.WindowCommand):
    def run(self):
        webbrowser.open_new_tab('https://github.com/karmicdude/sublime-boxy')


class BoxyWikiCommand(sublime_plugin.WindowCommand):
    def run(self):
        webbrowser.open_new_tab('https://github.com/karmicdude/sublime-boxy/wiki')
